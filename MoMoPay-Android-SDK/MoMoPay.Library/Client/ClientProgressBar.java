...
public class ClientProgressBar {
    ...
    private ClientProgressBar.onListennerDismissTimeOut Listener;
    private ClientProgressBar.onListennerDismiss ListenerNormal;

    public ClientProgressBar() {
    }

    public void setOnDismissTimeOutListenner(ClientProgressBar.onListennerDismissTimeOut onListennerDismissTimeOut) {
        this.Listener = onListennerDismissTimeOut;
    }

    public void setOnDismissListenner(ClientProgressBar.onListennerDismiss onListennerDismiss) {
